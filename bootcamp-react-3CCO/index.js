...
function App() {
    return (
        <React.Fragment>
            <h1>Dê uma nota de 0 a 10 para os nossos serviços</h1>
            <Contador titulo="Envio de Documentos" />
            <Contador titulo="Onboarding" />
            <Contador titulo="Validação de Documentos" />
        </React.Fragment>
    );
}
